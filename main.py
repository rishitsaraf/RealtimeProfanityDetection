...
sl.write('''
    # Introduction
    Implementing a profanity detection system which detects and filters out vulgarities seamlessly can promote our goal of building a professional and non-toxic environment for everyone to interact where people can be respectful of each other’s sentiment. 
...
sl.write(''' # Corpus
We have combined dataset from two publicly-available sources:
''')
sl.write('''
...
the “Wikipedia” dataset from this Kaggle competition published by Alphabet’s Conversation AI team, which contains comments from Wikipedia’s talk page edits. Each of these datasets contains text samples hand-labeled by humans through crowdsourcing sites like Figure Eight.
...
img77 =Image.open("cfm.png")
img99 = Image.open("lsses.png")
col4.header('Left Confusion Matrix')
col4.image(img77)
col4.image(img99)



col10,col11 = sl.columns((1,1))
